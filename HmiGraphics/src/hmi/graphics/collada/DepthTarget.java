 ...
 * @author Job Zwiers
 */
public class DepthTarget extends ColladaElement {
   ...
   public DepthTarget(Collada collada, XMLTokenizer tokenizer) throws IOException {
      super(collada);
      readXML(tokenizer); 
   }
...
@Override
    ...
    */
   private static final String XMLTAG = "depth_target";
