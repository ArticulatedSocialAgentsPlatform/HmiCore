 ...
 * @author Job Zwiers
 */
public class RGB extends ColladaElement {
 
   // attributes: 
   private String operator; // optional, REPLACE, MODULATE, ADD, DOT3_RGBA etc
   ...
   public RGB(Collada collada, XMLTokenizer tokenizer) throws IOException {
      super(collada);
      readXML(tokenizer);      
   }  
   ...
   public void decodeContent(XMLTokenizer tokenizer) throws IOException {
      while (tokenizer.atSTag()) {
         ...
         if (tag.equals(Argument.xmlTag()))  {                
            ...
            getCollada().warning(tokenizer.getErrorMessage("RGB: skip : " + tokenizer.getTagName()));
            tokenizer.skipTag();
         }
      }  
    ...
    */
   private static final String XMLTAG = "RGB";
