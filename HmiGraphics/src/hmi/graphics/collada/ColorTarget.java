 ...
 * @author Job Zwiers
 */
public class ColorTarget extends ColladaElement {
   ...
   public ColorTarget(Collada collada, XMLTokenizer tokenizer) throws IOException {
      super(collada); 
      readXML(tokenizer); 
   }
    ...
    */
   private static final String XMLTAG = "color_target";
