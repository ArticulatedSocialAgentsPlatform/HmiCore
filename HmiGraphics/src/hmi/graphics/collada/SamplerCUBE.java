 ...
 * @author Job Zwiers
 */
public class SamplerCUBE extends ColladaElement {
 
   // attributes: none
   // child elements:
   private Source source;  // required
   private String wrapS; // default value: WRAP 
   private String wrapT; // default value: WRAP only for sample3D SamplerCUBE, samplerCUBE, samplerDEPTH
   ...
   public SamplerCUBE(Collada collada, XMLTokenizer tokenizer) throws IOException {
      super(collada);
      readXML(tokenizer);     
   }
   ...
   public void decodeContent(XMLTokenizer tokenizer) throws IOException {
      while (tokenizer.atSTag()) {
         ...
         if (tag.equals(Extra.xmlTag()))  {                
            ...
            getCollada().warning(tokenizer.getErrorMessage("SamplerCUBE: skip : " + tokenizer.getTagName()));
            tokenizer.skipTag();
         }
      }    
    ...
    */
   private static final String XMLTAG = "samplerCUBE";
