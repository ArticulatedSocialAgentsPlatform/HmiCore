...
public class Matrix4d implements java.io.Serializable, Cloneable
{
    ...
    public double m33;
    /*
     * double[] tmp = new double[16]; double[] tmp_rot = new double[9]; // scratch matrix double[] tmp_scale = new double[3]; // scratch matrix
     */
     ...
     */
    public Matrix4d(double m00, double m01, double m02, double m03, double m10, double m11, double m12, double m13, double m20, double m21,
    ...
    /**
     * Constructs and initializes a Matrix4d from the quaternion, translation, and scale values; the scale is applied only to the rotational
    ...
    /**
     * Constructs and initializes a Matrix4d from the rotation matrix, translation, and scale values; the scale is applied only to the rotational
    ...
    /**
     * Performs an SVD normalization of this matrix in order to acquire the normalized rotational component; the values are placed into the Matrix3d
     * parameter.
     * 
    ...
    /**
     * Performs an SVD normalization of this matrix in order to acquire the normalized rotational component; the values are placed into the Quat4f
     * parameter.
     * 
    ...
    /**
     * Performs an SVD normalization of q1 matrix in order to acquire the normalized rotational component; the values are placed into the Quat4d
     * parameter.
     * 
    ...
    /**
     * Sets the scale component of the current matrix by factoring out the current scale (by doing an SVD) from the rotational component and
    ...
    /**
     * Sets the values in this Matrix4d equal to the row-major array parameter (ie, the first four elements of the array will be copied into the first
    ...
    /**
     * Sets the rotational component (upper 3x3) of this matrix to the matrix values in the double precision Matrix3d argument; the other elements of
     * this matrix are initialized as if this were an identity matrix (i.e., affine matrix with no translational component).
     * 
     * @param m1 the double precision 3x3 matrix
     */
    ...
    static void luBacksubstitution(double[] matrix1, int[] row_perm, double[] matrix2)
    {
        ...
        for (k = 0; k < 4; k++)
        {
            ...
            matrix2[cv + 4 * 0] = (matrix2[cv + 4 * 0] - matrix1[rv + 1] * matrix2[cv + 4 * 1] - 
                    matrix1[rv + 2] * matrix2[cv + 4 * 2] - matrix1[rv + 3]
                    * matrix2[cv + 4 * 3])
                    / matrix1[rv + 0];
        }
    }
    ...
    /**
     * Returns true if the Object t1 is of type Matrix4d and all of the data members of t1 are equal to the corresponding data members in this
     * Matrix4d.
     * 
    ...
    /**
     * Returns a hash code value based on the data values in this object. Two different Matrix4d objects with identical data values (i.e.,
     * Matrix4d.equals returns true) will return the same hash code value. Two objects with different data members may return the same hash value,
    ...
    /**
     * Transforms the point parameter with this Matrix4d and places the result into pointOut. The fourth element of the point input parameter is
     * assumed to be one.
     * 
    ...
    /**
     * Transforms the point parameter with this Matrix4d and places the result back into point. The fourth element of the point input parameter is
     * assumed to be one.
     * 
     * @param point the input point to be transformed.
     */
