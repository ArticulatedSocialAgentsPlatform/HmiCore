...
public final class Hanim
{
    ...
    public static final String l_upperarm_roll = "l_upperarm_roll";
    public static final String l_forearm_roll = "l_forearm_roll";
    public static final String r_upperarm_roll = "r_upperarm_roll";
    ...
    public static final String[] all_body_joints = new String[] { HumanoidRoot, sacroiliac, l_hip, l_knee, l_ankle, l_subtalar,
            ...
            l_middle0, l_middle1, l_middle2, l_middle3, l_ring0, l_ring1, l_ring2, l_ring3, l_pinky0, l_pinky1, l_pinky2, l_pinky3,
    ...
    public static final String[] ROLL_JOINTS = new String[] { l_upperarm_roll, r_upperarm_roll, l_forearm_roll, r_forearm_roll,
            l_thigh_roll, r_thigh_roll, r_calf_roll, l_calf_roll };
