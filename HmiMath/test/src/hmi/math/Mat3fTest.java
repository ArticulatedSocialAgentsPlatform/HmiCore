...
public class Mat3fTest
{
    ...
    public void setFromQuatScale()
    {
        ...
        assertTrue(Vec4f.epsilonEquals(q, qq, PRECISION));
    ...
    public void setFromAxisAngleScale()
    {
        ...
        assertTrue(Mat3f.epsilonEquals(m1, m2, PRECISION));
    }
     ...
     */
    @Test
    public void setGetRowTest()
    {
        float[] m = Mat3f.getMat3f();
        Mat3f.setRow(m, 0, Vec3f.getVec3f(1, 2, 3));
        Mat3f.setRow(m, 1, Vec3f.getVec3f(4, 5, 6));
        Mat3f.setRow(m, 2, Vec3f.getVec3f(7, 8, 9));
        float r0Res[] = Vec3f.getVec3f();
        float r1Res[] = Vec3f.getVec3f();
        float r2Res[] = Vec3f.getVec3f();
        Mat3f.getRow(m, 0, r0Res);
        Mat3f.getRow(m, 1, r1Res);
        Mat3f.getRow(m, 2, r2Res);
        Vec3fTestUtil.assertVec3fEquals(1, 2, 3, r0Res, PRECISION);
        Vec3fTestUtil.assertVec3fEquals(4, 5, 6, r1Res, PRECISION);
        Vec3fTestUtil.assertVec3fEquals(7, 8, 9, r2Res, PRECISION);
    }
     ...
     */
    @Test
    public void setGetColumnTest()
    {
        float[] m = Mat3f.getMat3f();
        Mat3f.setColumn(m, 0, Vec3f.getVec3f(1, 2, 3));
        Mat3f.setColumn(m, 1, Vec3f.getVec3f(4, 5, 6));
        Mat3f.setColumn(m, 2, Vec3f.getVec3f(7, 8, 9));
        float r0Res[] = Vec3f.getVec3f();
        float r1Res[] = Vec3f.getVec3f();
        float r2Res[] = Vec3f.getVec3f();
        Mat3f.getColumn(m, 0, r0Res);
        Mat3f.getColumn(m, 1, r1Res);
        Mat3f.getColumn(m, 2, r2Res);
        Vec3fTestUtil.assertVec3fEquals(1, 2, 3, r0Res, PRECISION);
        Vec3fTestUtil.assertVec3fEquals(4, 5, 6, r1Res, PRECISION);
        Vec3fTestUtil.assertVec3fEquals(7, 8, 9, r2Res, PRECISION);
    }
    ...
    public void testAdjugate_transpose()
    {
        ...
        Mat3f.set(mexpect, -3.0f, 6.0f, -3.0f, 6.0f, -12.0f, 6.0f, -3.0f, 6.0f, -3.0f);
        // showM();
        // System.out.println("adj=\n" + Mat3f.toString(adj));
        // showMexpect();
        assertTrue(Mat3f.epsilonEquals(adj, mexpect, PRECISION));
        float detExpect = 0.0f;
        assertTrue(Math.abs(det - detExpect) < PRECISION);
        ...
        Mat3f.set(m, 1.0f, 2.0f, 1.0f, 3.0f, 2.0f, 1.0f, 1.0f, 2.0f, 3.0f);
        det = Mat3f.adjugateTranspose(adj, m);
        Mat3f.set(mexpect, 4.0f, -8.0f, 4.0f, -4.0f, 2.0f, 0.0f, 0.0f, 2.0f, -4.0f);
        // showM();
        // System.out.println("adj=\n" + Mat3f.toString(adj));
        // showMexpect();
        assertTrue(Mat3f.epsilonEquals(adj, mexpect, PRECISION));
    ...
    public void testNorm()
    {
        ...
        Mat3f.set(m, 1.0f, 2.0f, 3.0f, 4.0f, 5.0f, 1.0f, 2.0f, 3.0f, 2.0f);
        ...
        assertTrue(Math.abs(n_2 - 8.544f) < PRECISION);
    ...
    public void testAdjugate()
    {
        ...
        Mat3f.set(mexpect, 4.0f, -4.0f, 0.0f, -8.0f, 2.0f, 2.0f, 4.0f, 0.0f, -4.0f);
        // showM();
        // System.out.println("adj=\n" + Mat3f.toString(adj));
        // showMexpect();
    ...
    public void testPolarDecompose()
    {
        ...
        Mat3f.set(m, 1.0f, 0.0f, 0.0f, 0.0f, ca, -sa, 0.0f, sa, ca);
        float[] Q = new float[9];
        float[] S = new float[9];
        ...
        float epsilon = PRECISION; // determines smoothing for the scaling and the rotation
        Mat3f.polarDecompose(m, Q, S);
        Mat3f.ScalingType scaleType = Mat3f.getScalingType(S);
        // System.out.println("m=\n" + Mat3f.toString(m));
        // System.out.println("Q=\n" + Mat3f.toString(Q));
        // System.out.println("S=\n" + Mat3f.toString(S));
        assertTrue(Mat3f.epsilonEquals(Q, Qexpect, PRECISION));
        assertTrue(Mat3f.epsilonEquals(S, Sexpect, PRECISION));
        ...
        assertTrue(Mat3f.epsilonEquals(Q, Qexpect, PRECISION));
        assertTrue(Mat3f.epsilonEquals(S, scale, PRECISION));
    ...
    public void skew()
    {
        ...
        Vec3f.cross(d, a, b);
        assertTrue(Vec3f.epsilonEquals(c, d, PRECISION));
    }
    ...
    public void testInvert()
    {
        ...
        assertTrue(Mat3f.epsilonEquals(m, Mat3f.getIdentity(), PRECISION));
        Mat3f.set(m, 1.0f, 2.0f, 3.0f, 4.0f, 5.0f, 6.0f, 7.0f, 8.0f, 9.0f);
    ...
    public void mulTransposeRight()
    {
        ...
        assertTrue(Mat3f.epsilonEquals(dest, dest2, PRECISION));
    }
    ...
    public void testIsDiagonal()
    {
        ...
        Mat3f.set(m, 1.0f, 0.00001f, 0.000001f, 0.000001f, 2.0f, 0.000001f, 0.000001f, 0.000001f, 3.0f);
        ...
        assertTrue(Mat3f.isDiagonal(m, PRECISION));
    }
    ...
    public void testIsSymmetric()
    {
        ...
        assertTrue(Mat3f.isSymmetric(m, PRECISION));
        Mat3f.set(m, 1.0f, 6.0f, 3.0f, 2.0f, 4.0f, 5.0f, 3.0f, 5.0f, 6.0f);
        assertFalse(Mat3f.isSymmetric(m, PRECISION));
