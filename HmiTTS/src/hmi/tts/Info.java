...
package hmi.tts;  // change this line for other packages
...
public final class Info {
   ...
   public final static String PACKAGE_NAME = pack.getName();
   ...
   public static String manifestInfo() {
       ...
       buf.append("Package: ");  buf.append(PACKAGE_NAME); buf.append("\n");
   ...
   public static void requireVersion(String requiredVersion) {
      ...
      String msg = "Package " + PACKAGE_NAME + " Version " + pack.getSpecificationVersion() 
   ...
   public static boolean isCompatibleWith(String desiredVersion) {
       ...
       try {
          ...
          return true;
            ...
            System.out.println(PACKAGE_NAME + ".Info.isCompatibelWith method: illegal version numbers: " + desiredVersion + " / "
